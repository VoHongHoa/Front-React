                ...
                <div className="login-container">
                    <div className="login-content row">
                        ...
                        <div className='col-12 form-group login-input'>
                            ...
                            <input type='text' value={this.state.username} onChange={(event)=>this.handleOnChangeUsername(event)} placeholder='Enter your username' className='form-control'/>
                        </div>
                        <div className='col-12 form-group login-input'>
                            ...
                            <input type={this.state.isShowpassword ? 'password' : 'text'} value={this.state.password} onChange={(event)=>this.handleOnChangePassword(event)} placeholder='Enter your password' className='form-control'/>
